...
TRUNCATE TABLE resgate_vantagem RESTART IDENTITY CASCADE;
...
VALUES 
(1, 'Arthur Professor', 'arthurjardimfreitas@gmail.com', '123')
ON CONFLICT DO NOTHING;

INSERT INTO professor (id, cpf, departamento, instituicao_id, saldo_corrente)
VALUES
(1, '98765432100', 'Engenharia de Software', 1, 1000)
ON CONFLICT DO NOTHING;
